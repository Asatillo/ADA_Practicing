...
procedure shopping is
    ...
    type PString is access String;
     ...
     --  Altogether, create 2-2-2 dynamic shops in an array, opening at 2
    --  minutes intervals. Now the customers are choosing randomly the index of the shops and they make 3
    --  trials for 3 random shops. If they are not served immediately will chose another one, then after the
    --  third trial they would go home.
